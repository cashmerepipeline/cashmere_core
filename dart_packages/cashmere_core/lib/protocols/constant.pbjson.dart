...
@$core.Deprecated('Use getConstantsRequestDescriptor instead')
...
const GetConstantsResponse$json = {
  '1': 'GetConstantsResponse',
  '2': [
    {'1': 'constants', '3': 1, '4': 3, '5': 12, '10': 'constants'},
  ],
};

/// Descriptor for `GetConstantsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getConstantsResponseDescriptor = $convert.base64Decode(
    'ChRHZXRDb25zdGFudHNSZXNwb25zZRIcCgljb25zdGFudHMYASADKAxSCWNvbnN0YW50cw==');
