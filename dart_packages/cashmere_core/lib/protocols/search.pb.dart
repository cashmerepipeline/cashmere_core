...
class SearchRequest extends $pb.GeneratedMessage {
  factory SearchRequest({
    ...
    if (searchParams != null) {
      $result.searchParams.addAll(searchParams);
    }
    return $result;
  }
...
class SearchResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'cashmere'), createEmptyInstance: create)
