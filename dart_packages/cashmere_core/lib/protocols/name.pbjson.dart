...
const RenameRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'new_name', '3': 3, '4': 1, '5': 11, '6': '.cashmere.Name', '10': 'newName'},
  ],
};

/// Descriptor for `RenameRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List renameRequestDescriptor = $convert.base64Decode('Cg1SZW5hbWVSZXF1ZXN0EhsKCW1hbmFnZV9pZBgBIAEoBVIIbWFuYWdlSWQSGwoJZW50aXR5X2lkGAIgASgJUghlbnRpdHlJZBIpCghuZXdfbmFtZRgDIAEoCzIOLmNhc2htZXJlLk5hbWVSB25ld05hbWU=');
...
final $typed_data.Uint8List newLanguageNameRequestDescriptor = $convert.base64Decode('ChZOZXdMYW5ndWFnZU5hbWVSZXF1ZXN0EhsKCW1hbmFnZV9pZBgBIAEoBVIIbWFuYWdlSWQSGwoJZW50aXR5X2lkGAIgASgJUghlbnRpdHlJZBIpCghuZXdfbmFtZRgDIAEoCzIOLmNhc2htZXJlLk5hbWVSB25ld05hbWU=');
