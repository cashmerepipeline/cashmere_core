...
const GetSetDataInfoResponse$json = const {
  ...
  '2': const [
    const {'1': 'data_info', '3': 1, '4': 1, '5': 11, '6': '.cashmere.SetDataInfo', '10': 'dataInfo'},
  ],
};

/// Descriptor for `GetSetDataInfoResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSetDataInfoResponseDescriptor = $convert.base64Decode('ChZHZXRTZXREYXRhSW5mb1Jlc3BvbnNlEjIKCWRhdGFfaW5mbxgBIAEoCzIVLmNhc2htZXJlLlNldERhdGFJbmZvUghkYXRhSW5mbw==');
...
final $typed_data.Uint8List setDataUploadFileRequestDescriptor = $convert.base64Decode('');
...
const SetDataUploadFilesRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'current_chunk_index', '3': 3, '4': 1, '5': 4, '10': 'currentChunkIndex'},
    const {'1': 'chunk', '3': 4, '4': 1, '5': 12, '10': 'chunk'},
    const {'1': 'file_info', '3': 5, '4': 3, '5': 11, '6': '.cashmere.FileInfo', '10': 'fileInfo'},
...
final $typed_data.Uint8List setDataUploadFilesRequestDescriptor = $convert.base64Decode('');
