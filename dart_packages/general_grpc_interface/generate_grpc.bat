...
protoc -I../../protocols  --dart_out=lib/grpc_generated  ../../protocols/data_type.proto
protoc -I../../protocols  --dart_out=lib/grpc_generated  ../../protocols/file_transfer.proto
...
protoc -I../../protocols  --dart_out=lib/grpc_generated  ../../protocols/gender.proto
